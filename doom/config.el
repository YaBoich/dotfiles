...
;; TODO: since I might wanna switch between this and my emacs config, I can checkout this:
...
;; Find font with `describe-font'
;; To reload `eval-region' then `reload-font'
(setq doom-font (font-spec :familty "Fira Code" :size 20))
