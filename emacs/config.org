...
** Emacs as a Multiplexer (TMUX replacement)

Check out [[https://www.youtube.com/watch?v=X8c_TrGfYcM][This video]]

Ok so I can use M-x Shell

Then C-p and C-n to go through uparrow/downarrow list

*** named shell buffers

#+begin_src emacs-lisp
  (defun spawn-shell (name)
    "Create a neew shell buffer with the given name."
...
*** vterm
This dude likes vterm over shell tho, which I might not be able to use on OSX.
Install vterm
...
Multi-vterm is also a thing

Need to install something called libtool-bin
